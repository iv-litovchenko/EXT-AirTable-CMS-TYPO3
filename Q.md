```
> Остановился на Eav DataType, Data (досравнить _TCA-OLD)
---------
Общее
---------
* Убрать thisIs и typo3 для элементов контента
* Hooks авторегистрация
* https://www.toujou.com/service/element-library/blog-elements/
