...
* Flux: оптимизировать провайдеры для страниц и элементов содержимого (сейчас идет массовая регистрация провайдеров). Сделать 1 провайдер для страницы и 1 провайдер для элементов содержимого, где разбирать что это за страница/элемент контента. Сделать работу двух данных провайдеров совместимой с другими расширениями на базе Flux
