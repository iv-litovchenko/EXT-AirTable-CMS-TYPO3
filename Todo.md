...
1 проверка полей
2 правильно ли сделал описание создания нового типа?
3. правильно ли сделал описание создания характеристики?
4 связи
...
Новая запись диалог
Server files and folders enum
Order rand sort в настройках списков на вкладке сортировки...

Модуль список:	Для таких записей как комментарии сделать раскрыашку списка где будет детальная информация о записи типа SHOW
Модуль список: Для типа пмкиограм просмотреть инфо show action
Модуль список: Annotation  для таблиц DefaultShowType
