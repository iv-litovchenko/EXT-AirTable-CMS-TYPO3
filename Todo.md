...
```
Атрибуты относятся к дополнительной информации об объекте. Свойства описывают характеристики объекта. Большинство людей используют эти два слова как синонимы. 
