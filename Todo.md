...
4. Выборка Data + атрибуты + фильтрация
5. Поля (атрибуты) в контроллерах...
6. // Todo - общие поля для всех типов сущности На примере страниц - будут показываться во всех шаблонах
7. То поле Flexform
8. Проверить работу связи EAV когда убрал where (будул ли свойства правильно выводится если у сущностей одинаковые ID)
