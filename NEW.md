```
2) Трайты 
2.-1 Сверить кол-во аннотаций в свойствах && !strstr($doc,'@AirTable\Field:<Special') foreach($v::$TYPO3['fields'] as $k2 => $v2){
2.0 Не правильно называется класс AltTitle.php Поле alttitle
...
5) EX (сверить)
6) Удалить аннотации...  * @AirTable\Field:
