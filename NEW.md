```
1. Проверить наличие массива FIELDS>>> где сть $TYPO3
1. COMPARE Сравнить название переменных и их количество
2. COMPARE Сравнить аннотации...
3. Проверить регистр - все аннотации должны быть с маленькой буквы...
4. Удалить аннотации...  * @AirTable\Field:
Посмотреть SQL Анализер (запустить и посмотреть будут ли изменения в БД?)
