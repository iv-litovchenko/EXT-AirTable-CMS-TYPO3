...
2.1 БЕ-модули Signature AnnotationRegistrationExtTables.php
2.2 Проверить BE-модули где было в ручную генерировалось для Путей перекидки на экспорт/импорт!

3 Проверить TYPOSCRIPT
4 Проверить в других версиях тайпы...
