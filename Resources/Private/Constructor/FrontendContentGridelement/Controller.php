<?php
namespace ###NAMESPACE_1###\###NAMESPACE_2###\Controller\PagesElements\Gridelements;
...
class ###KEY###Controller extends \FluidTYPO3\Flux\Controller\ContentController
{
     ...
     */
    public static $TYPO3 = [
        'thisIs' => 'FrontendContentGridelement',
        'name' => '###NAME###',
        'description' => '###DESCRIPTION###',
        'fieldsExcludeList' => 'header_position,date',
        'fieldsAddList' => 'imageorient',
        'nonCachedActions' => '', // USER_INT
        'ajaxActions' => '' // http://your-site.com/?eIdAjax=1&eIdAjaxPath=Ext.###NAMESPACE_2###.Gridelements.###KEY###.index - See "Ajax-Frontend"
    ];
